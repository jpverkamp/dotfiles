...
# Docker aliases
alias docker-nuke="docker ps -q | xargs docker kill"
alias docker-bash="docker exec -it $(docker ps -q | head -n 1) bash"
alias docker-cleanup="docker images | grep '<none>' | awk '{print $3;}' | xargs docker rmi -f"
